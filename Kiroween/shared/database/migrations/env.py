"""
Alembic environment configuration for Medi OS database migrations.

This module configures Alembic for async SQLAlchemy with proper
multi-hospital database support and medical data validation.
"""
...
def get_database_url() -> str:
    ...
    Supports hospital-specific URLs for multi-hospital deployment.
    """
