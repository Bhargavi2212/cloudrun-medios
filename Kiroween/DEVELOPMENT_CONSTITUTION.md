...
├── data/ # Shared datasets (NOT in git)
├── apps/
...
│ └── README.md
└── services/
├── manage-agent/ # Triage service (port 8001)
│ ├── core/ # Business logic
│ ├── handlers/ # API routes
...
│ ├── Dockerfile
│ └── README.md
├── scribe-agent/ # SOAP generation (port 8002)
│ └── [same structure]
└── summarizer-agent/ # Patient history (port 8003)
└── [same structure]
...
- 📊 Info: "📊 Training accuracy: 0.89"
- 🚀 Start: "🚀 Starting API server"
- 📥 Load: "📥 Downloading dataset"
- ⚠️ Warning: "⚠️ High latency detected"
...
- Never add print statements just to make code appear to work
- Never change tests to make them pass without fixing the actual issue
- All code must work in production deployment
- No shortcuts that break in real environments

## PRODUCTION READINESS
- Code must handle real data and real errors
- All external dependencies must be properly configured
- Error handling must be comprehensive and meaningful
- Performance must meet stated targets
- Security must be production-grade

## TESTING INTEGRITY
- Tests must validate actual functionality, not fake outputs
- Never modify tests to pass without fixing underlying issues
- Integration tests must use real service interactions
- All edge cases must be properly handled

# ==============================================================================
# END OF DEVELOPMENT CONSTITUTION
