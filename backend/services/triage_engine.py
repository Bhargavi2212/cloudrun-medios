...
class TriageEngine:
    ...
    def calculate_triage_level(self, vitals: VitalsSubmission, chief_complaint: str) -> TriageResult:
        ...
        if self.model is not None:
            try:
                ...
                if (
                    ai_triage_level == 5
                    and any(keyword in complaint_lower for keyword in critical_keywords)
                    and rule_based_level in [1, 2]
                ):

                    print(
                        f"AI model gave Level 5 for critical case '{chief_complaint}', using rule-based Level {rule_based_level}"
                    )
    ...
    def _check_level_1_criteria(self, vitals: VitalsSubmission, chief_complaint: str) -> bool:
        ...
        if (
            ...
            or vitals.temperature_celsius > 39.0
        ):
            return True
    ...
    def _check_level_2_criteria(self, vitals: VitalsSubmission, chief_complaint: str) -> bool:
        ...
        if (
            ...
            or vitals.blood_pressure_systolic < 100
            or vitals.oxygen_saturation < 95
            or vitals.temperature_celsius > 37.5
        ):
            return True
    ...
    def _check_vital_signs(self, vitals: VitalsSubmission, level: str) -> bool:
        ...
        if level == "level_3":
            ...
            return (
                60 <= vitals.heart_rate <= 100
                and 90 <= vitals.blood_pressure_systolic <= 140
                and 95 <= vitals.oxygen_saturation <= 100
                and 36.0 <= vitals.temperature_celsius <= 37.5
            )
        return False
    ...
    def _load_esi_guidelines(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "level_4": {
                ...
                "criteria": ["Simple workup", "Single resource needed"],
            },
            "level_5": {
                "description": "No resources needed",
                "criteria": ["Simple prescription", "No resources needed"],
            },
        }
