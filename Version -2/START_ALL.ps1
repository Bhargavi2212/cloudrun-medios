...
Write-Host '  $env:DATABASE_URL="postgresql+asyncpg://username:password@localhost:5432/medi_os_v2"' -ForegroundColor Gray
Write-Host '  $env:GEMINI_API_KEY="your-gemini-api-key-here"' -ForegroundColor Gray
