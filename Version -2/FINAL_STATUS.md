...
- DATABASE_URL - PostgreSQL connection string (e.g., `postgresql+asyncpg://user:pass@localhost:5432/medi_os_v2`)
...
**Note:** This system is configured for development/testing. For production deployment, ensure:
- All secrets are managed via secure secret management (not hardcoded)
- Proper error handling and retry logic is implemented
- Database connection pooling is tuned for expected load
