...
uvicorn services.summarizer_agent.main:app --reload --port 8003
```
...
docker run --env-file services/summarizer_agent/env.example -p 8003:8003 summarizer-agent:latest
```
