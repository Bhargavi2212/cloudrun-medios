...
def get_federated_trainer(request: Request) -> FederatedTrainer | None:
    """
    Retrieve the federated trainer if configured.
    """

    return getattr(request.app.state, "federated_trainer", None)
