...
- **Assumptions**
  ...
  - Password: `Anuradha`
  - Databases:
    - `medi_os_v2` (main app DB)
    - `medi_os_v2_test` (test DB)
...
$env:TEST_DATABASE_URL = "postgresql+asyncpg://postgres:Anuradha@localhost:5432/medi_os_v2_test"
...
- **Service container**
  ...
  - Password: `postgres`
  - Databases:
    - `medi_os_v2` (created by the container)
    - `medi_os_v2_test` (created in the workflow)

The CI workflow (`.github/workflows/ci.yml`) sets:

```text
DATABASE_URL=postgresql+asyncpg://postgres:postgres@localhost:5432/medi_os_v2
TEST_DATABASE_URL=postgresql+asyncpg://postgres:postgres@localhost:5432/medi_os_v2_test
```
