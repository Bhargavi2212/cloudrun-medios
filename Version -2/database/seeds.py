    ...
    patients_seed = [
        {
            ...
            "encounters": [
                {
                        ...
                        "speaker_segments": [
                            {
                                "speaker": "nurse",
                                "content": (
                                    "Alex, we're going to run a quick pulmonary check."
                                ),
                            },
                            {
                                "speaker": "patient",
                            ...
                            },
                            {
                                "speaker": "doctor",
                                "content": (
                                    "We'll start a nebulizer and reassess in "
                                    "thirty minutes."
                                ),
                            },
                        ],
                    ...
                    "soap_note": {
                        "subjective": (
                            "Reports dyspnea onset during outdoor event, minimal "
                            "chest pain."
                        ),
                        "objective": (
                        ...
                        "assessment": (
                            "Exercise-induced bronchospasm with viral trigger "
                            "unlikely."
                        ),
                        "plan": (
                ...
                },
                {
                    ...
                    "transcript": {
                        ...
                        "speaker_segments": [
                            ...
                            },
                            {
                                "speaker": "doctor_remote",
                                "content": (
                                    "Continue inhaler pre-activity and schedule "
                                    "spirometry."
                                ),
                            },
                        ],
                    ...
                    "soap_note": {
                        "subjective": (
                            "Telehealth review confirms decreased symptoms post "
                            "discharge."
                        ),
                        "objective": (
                            "Peak flow self-reported at 470 L/min, no audible wheeze."
                        ),
                        "assessment": (
                            "Asthma control improving; continue current regimen."
                        ),
                        "plan": (
                            "Maintain preventive inhaler use, schedule pulmonary "
            ...
            "summary": {
                "summary_text": (
                    "Two encounters within 2 days for bronchospasm management. "
                    "Local ED provided acute therapy; remote partner conducted "
                    "telehealth follow-up. Patient stable with action plan."
                ),
            ...
            "encounters": [
                {
                    ...
                    "soap_note": {
                        "subjective": (
                            "Three-day history of fever, chills, productive cough "
                            "with rust-colored sputum."
                        ),
                        "objective": (
                ...
                },
                {
                    ...
                    "transcript": {
                        "transcript": (
                            "Partner Physician: Symptoms concerning for pneumonia, "
                            "transferring to Kiroween ED.\n"
                            "Patient: I've never had breathing trouble like this.\n"
                            "Partner Physician: Ambulance en route; records synced "
                            "to your digital passport."
                        ),
                        "speaker_segments": [
                            {
                                "speaker": "doctor_partner",
                                "content": (
                                    "Symptoms concerning for pneumonia, transferring "
                                    "to Kiroween ED."
                                ),
                            },
                            {
                            ...
                            },
                            {
                                "speaker": "doctor_partner",
                                "content": (
                                    "Ambulance en route; records synced to your "
                                    "digital passport."
                                ),
                            },
                        ],
                    ...
                    "soap_note": {
                        ...
                        "assessment": (
                            "Moderate respiratory infection, concern for lower "
                            "lobe pneumonia."
                        ),
                        "plan": (
                            "Transfer to tertiary center, upload vitals to portable "
                            "profile for continuity."
                        ),
                        "model_version": "scribe_partner_v1",
            ...
            "encounters": [
                {
                    ...
                    "transcript": {
                        ...
                        "speaker_segments": [
                            ...
                            },
                            {
                                "speaker": "doctor",
                                "content": (
                                    "No stitches required; keep the area dry for "
                                    "48 hours."
                                ),
                            },
                        ],
                    ...
                    "soap_note": {
                        ...
                        "objective": (
                            "2.5 cm superficial cut, no foreign body, intact "
                            "neurovascular exam."
                        ),
