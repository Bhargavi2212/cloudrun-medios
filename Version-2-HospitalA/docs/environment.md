...
| Variable | Description | Default |
| -------- | ----------- | ------- |
| `VITE_MANAGE_API_URL` | Manage-agent base URL. | `http://localhost:8001` |
| `VITE_SCRIBE_API_URL` | Scribe-agent base URL. | `http://localhost:8002` |
| `VITE_SUMMARIZER_API_URL` | Summarizer-agent base URL. | `http://localhost:8003` |
