...
if (-not $env:DATABASE_URL) {
    ...
    $env:DATABASE_URL = "postgresql+asyncpg://postgres:$dbPasswordPlain@localhost:5432/medi_os_v2_a"
}
...
Write-Host '  $env:DATABASE_URL="postgresql+asyncpg://postgres:YOUR_PASSWORD@localhost:5432/medi_os_v2_a"' -ForegroundColor Gray
