...
print("3. Start manage-agent: uvicorn services.manage_agent.main:app --port 9001")
print(
    "4. Start summarizer-agent: uvicorn services.summarizer_agent.main:app --port 9003"
)
