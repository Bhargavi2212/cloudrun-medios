...
class DocumentProcessor:
    ...
    async def _step1_clean_text(
        ...
        system_instruction = """You are a medical document text cleaning expert. Clean OCR/PDF text, fix errors, identify sections, and normalize formatting. Return only the cleaned text, no JSON."""  # noqa: E501
...
Return the cleaned text only."""
    ...
    async def _step2_extract_data(self, cleaned_text: str) -> dict[str, Any] | None:
        ...
        system_instruction = """You are a medical data extraction expert. Extract structured medical information from clinical documents. Return valid JSON only."""  # noqa: E501
