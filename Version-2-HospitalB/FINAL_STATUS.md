...
- MANAGE_AGENT_STORAGE_ROOT - Default: ./storage/hospital_b
- SUMMARIZER_AGENT_STORAGE_ROOT - Default: ./storage/hospital_b
...
Frontend (React + MUI)
  ...
  └─ DocumentsPage (Tabs)
       ↓
Manage-Agent (FastAPI :9001)
  ├─ Storage Service
  ├─ File Asset Service
  └─ Document Upload/Management Endpoints
       ↓
Summarizer-Agent (FastAPI :9003)
